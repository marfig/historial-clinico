...
using HistorialClinico.Web.Models.ManageViewModels;
...
namespace HistorialClinico.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            return string.Format(AuthenicatorUriFormat, _urlEncoder.Encode("HistorialClinico.Web"), _urlEncoder.Encode(email), unformattedKey);
        }
    }
}
