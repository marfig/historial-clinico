...
using HistorialClinico.Web.Extensions;
using HistorialClinico.Web.Models.AccountViewModels;
...
namespace HistorialClinico.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult _List(DataSourceRequest command)
        {
            var model = _userManager.Users.Select(c => new
            {
                c.UserName,
                c.Email
            });
        ...
        [HttpPost]
        public async Task<JsonResult> AddUsuario(RegisterViewModel model)
        {
            ...
            return Json(new { Success = false, ErrorMessage = "Ocurrió un error. No se pudo guardar el usuario" });
        }
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            await _emailSender.SendEmailAsync(model.Email, "Actualizar Contraseña", $"Para actualizar su contraseña ingrese al siguiente <a href='{callbackUrl}'>link</a>");
        ...
        private async Task SendEmailConfirmationAsync(string Email, string callback)
        {
            var message = $"Su usuario ha sido creado. Para acceder click <a href='{callback}'>aquí</a>";
            
            await _emailSender.SendEmailAsync(Email, "Historial Clínico - Acceso de usuario", message);
        }
    }
}
